      ...
      <div className="container">
        <div>
              ...
              <div className="dropdown">
                ...
                >
                  ...
                  <li onClick={() => categoryField('FE')}>
                    <button className="dropdown-item">Front End</button>
                  </li>
                  <li onClick={() => categoryField('BE')}>
                    <button className="dropdown-item">Back End</button>
                  </li>
                  <li onClick={() => categoryField('Data')}>
                    <button className="dropdown-item">Data</button>
                  </li>
                  <li onClick={() => categoryField('DevOps')}>
                    <button className="dropdown-item">DevOps</button>
                  </li>
                </ul>
              </div>
            </div>
          ...
          {totalAmountOfBooks > 0 ? (
            <>
              <div className="mt-3">
                <h5>Number of books: ({totalAmountOfBooks})</h5>
              </div>
              <p>
